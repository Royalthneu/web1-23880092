...
<head>
    <title>23880092 - WEB1 PROJECT</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Font-awsome -->
    <script src="https://kit.fontawesome.com/e0f2415d85.js" crossorigin="anonymous"></script>
    ...
    <!-- Web1 CSS -->
    <link rel="stylesheet" href="./css/23880092.css" />
</head>
...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="py-3">
            ...
            <p class="text-black-50">
                ...
                natus! A praesentium ab dolorum blanditiis excepturi nobis quia,
                laboriosam nulla. Aspernatur minima illo blanditiis eveniet voluptatem
                temporibus in, nesciunt quam?
            </p>
            <p class="text-black-50"><i>Send an email. All fileds with an * are required</i></p>
            <form action="#" method="post" class="text-black-50" onsubmit="onSubmit(event)">
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
        ...
        <div class="text-end">
            <div class="form-check">
                <label class="form-check-label" for="copy"> Send copy to yourself &nbsp;&nbsp;</label>
                <input type="checkbox" value="1" id="copy" />&nbsp;&nbsp;
    ...
    <footer class="text-center container-fluid text-white py-3">
        ...
        <p class="text-white-50">
            Copyright &copy;2025 by Nguyen The Trung - 23880092
        </p>
    </footer>
    ...
    <script src="js/23880092.js"></script>
    ...
    <script src="https://www.google.com/recaptcha/enterprise.js?render=6LeVi0crAAAAACWNeBYdpW93zC5r_vgcpOUQeGkL"></script>
    <script>
        function onSubmit(e) {
          e.preventDefault();
          grecaptcha.enterprise.ready(function () {
            grecaptcha.enterprise.execute('6LeVi0crAAAAACWNeBYdpW93zC5r_vgcpOUQeGkL', {action: 'submit'}).then(async function(token){
